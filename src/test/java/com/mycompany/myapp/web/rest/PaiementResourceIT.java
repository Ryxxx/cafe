...
class PaiementResourceIT {
    ...
    void createPaiement() throws Exception {
        ...
        assertThat(testPaiement.getQuantite()).isEqualTo(DEFAULT_QUANTITE);
        assertThat(testPaiement.getProvider()).isEqualTo(DEFAULT_PROVIDER);
    ...
    void putNewPaiement() throws Exception {
        ...
        Paiement testPaiement = paiementList.get(paiementList.size() - 1);
        assertThat(testPaiement.getQuantite()).isEqualTo(UPDATED_QUANTITE);
        assertThat(testPaiement.getProvider()).isEqualTo(UPDATED_PROVIDER);
    ...
    void partialUpdatePaiementWithPatch() throws Exception {
        ...
        partialUpdatedPaiement.provider(UPDATED_PROVIDER).statut(UPDATED_STATUT);
